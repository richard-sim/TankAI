...
namespace net
{
    ...
    bool Socket::Send( const Address & destination, const void * data, int size )
    {
        ...
        int sent_bytes = (int)sendto( socket, (const char*)data, size, 0, (sockaddr*)&address, sizeof(sockaddr_in) );
    ...
    int Socket::Receive( Address & sender, void * data, int size )
    {
        ...
        int received_bytes = (int)recvfrom( socket, (char*)data, size, 0, (sockaddr*)&from, &fromLength );
